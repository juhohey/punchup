...
public class MainActivity extends SampleActivityBase {
    ...
    public static ArrayList<Foo> foo = new ArrayList();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            fragmentManager.beginTransaction()
                    .replace(R.id.sample_content_fragment, (Fragment) sketch)
                    .commit();

            /*RelativeLayout.LayoutParams p = new RelativeLayout.LayoutParams(newWidth, newHeight);
            sketch.getView().setLayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
            sketch.getView().requestLayout();*/
        }
    }
