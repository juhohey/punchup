...
public class SensorFragment extends Fragment implements SensorEventListener {
    ...
    private static final int SHAKE_WAIT_TIME_MS = 150;
    ...
    private PunchSwingDetector punchSwingDetector = new PunchSwingDetector();
    ...
    public void onSensorChanged(SensorEvent event) {
       ...
       // );
        ...
        PunchSwingDetector.Event pEvent =  punchSwingDetector.addEvent(event);
          if(pEvent == PunchSwingDetector.Event.PUNCH) {
              //detectShake(event);
              mView.setBackgroundColor(Color.rgb(3, 169, 244));
              mTextValues.setText("Punch!");
          }
        //}
        else if(pEvent == PunchSwingDetector.Event.SWING) {
              mView.setBackgroundColor(Color.rgb(255, 64, 129));
              mTextValues.setText("Clap!");
                //detectRotation(event);
        }
        else if (System.currentTimeMillis() - punchSwingDetector.timeOflastEventDetected > 450) {
